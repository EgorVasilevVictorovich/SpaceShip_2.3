package com.example.polet.entity;
...
import com.example.polet.GameView;
import com.example.polet.R;
...
public class Flight {
    ...
    public Flight(GameView gameView, int screenX, int screenY, Resources resources) {
        ...
        flight1 = BitmapFactory.decodeResource(resources, R.drawable.flip1);
        flight2 = BitmapFactory.decodeResource(resources, R.drawable.flip2);

        // считывание изображения подбитого самолёта из ресурсов
        planeShotDown = BitmapFactory.decodeResource(resources, R.drawable.flip7);

        // считывание изображений атакующих самолётов из ресурсов
        shoot1 = BitmapFactory.decodeResource(resources, R.drawable.flip1);
        shoot2 = BitmapFactory.decodeResource(resources, R.drawable.flip2);
        shoot3 = BitmapFactory.decodeResource(resources, R.drawable.flip3);
        shoot4 = BitmapFactory.decodeResource(resources, R.drawable.flip4);
        shoot5 = BitmapFactory.decodeResource(resources, R.drawable.flip6);
